...
void FX_DEMP2_ProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
{
	...
	cgi.FX_PlayEffectID( cgs.effects.demp2ProjectileEffect, cent->lerpOrigin, forward, -1, -1 );
}
...
{
	cgi.FX_PlayEffectID( cgs.effects.demp2WallImpactEffect, origin, normal, -1, -1 );
}
...
{
	cgi.FX_PlayEffectID( cgs.effects.demp2FleshImpactEffect, origin, normal, -1, -1 );
}
...
/*
	...
	FX_AddBezier( start, targ1,
						...
						1.0f, 0.0f, 0.0f,
						chaos, chaos, 0.0f,
						1.0f, cgi.R_RegisterShader( "gfx/misc/electric2" ), FX_ALPHA_LINEAR );
	...
	FX_AddSprite( c1, NULL, NULL, 12.0f + crandom() * 4, 0.0f, 1.0f, 1.0f, random() * 360, 0.0f, 1.0f, 
						cgi.R_RegisterShader( "gfx/misc/lightningFlash" ));
