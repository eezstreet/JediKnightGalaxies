...
void FX_BowcasterProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
{
	...
	cgi.FX_PlayEffectID( cgs.effects.bowcasterShotEffect, cent->lerpOrigin, forward, -1, -1 );
}
...
{
	cgi.FX_PlayEffectID( cgs.effects.bowcasterImpactEffect, origin, normal, -1, -1 );
}
