...
void FX_FlechetteProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
{
	...
	cgi.FX_PlayEffectID( cgs.effects.flechetteShotEffect, cent->lerpOrigin, forward, -1, -1 );
}
...
{
	cgi.FX_PlayEffectID( cgs.effects.flechetteWallImpactEffect, origin, normal, -1, -1 );
}
...
//	if ( humanoid )
//	{
		cgi.FX_PlayEffectID( cgs.effects.flechetteFleshImpactEffect, origin, normal, -1, -1 );
//	}
//	else
//	{
//		cgi.FX_PlayEffect( "blaster/droid_impact", origin, normal );
//	}
}
...
void FX_FlechetteAltProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
{
	...
	cgi.FX_PlayEffectID( cgs.effects.flechetteAltShotEffect, cent->lerpOrigin, forward, -1, -1 );
}
