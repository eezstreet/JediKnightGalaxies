...
void	trap_R_AddPolysToScene( qhandle_t hShader , int numVertsPerPoly, const polyVert_t *verts, int num ) {
	syscall( CG_R_ADDPOLYSTOSCENE, hShader, numVertsPerPoly, verts, num );
}
...
void trap_FX_PlayEffectID( int id, const vec3_t org, const vec3_t fwd, int vol, int rad )
{
