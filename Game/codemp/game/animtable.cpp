...
//===End Saber locks==================================================================
	...
	ENUM2STRING(BOTH_PRONEDOWN),
	ENUM2STRING(BOTH_PRONEUP),
	ENUM2STRING(BOTH_PRONESTANCE),
	ENUM2STRING(BOTH_PRONEREADY),
	ENUM2STRING(BOTH_PRONEFIRE),
	ENUM2STRING(BOTH_PRONECRAWL),
	ENUM2STRING(BOTH_PRONECRAWLBACK),
	ENUM2STRING(BOTH_PRONECRAWLLEFT),
	ENUM2STRING(BOTH_PRONECRAWLRIGHT),
	...
	ENUM2STRING (BOTH_SPRINT),
	ENUM2STRING (BOTH_FEMALERUN),
	
	ENUM2STRING (BOTH_TWIST),
    ENUM2STRING (BOTH_MUFA),
    ENUM2STRING (BOTH_BOFA),
