...
|* g_engine.h
|*
|* This header contains engine struct definitions and
|* provides access to internal server structures
|*
...
|* These are staticly defined so any c file including this header can make use of it
\*/

#ifdef __linux__
	static serverStatic_t *svs = (serverStatic_t *)0x083121E0;
#else
	static serverStatic_t *svs = (serverStatic_t *)0x00606218;
#endif