...
void AllocatePathFindingMemory()
{
	...
	openlist = malloc(sizeof(int)*(MAX_WPARRAY_SIZE));
	gcost = malloc(sizeof(float)*(MAX_WPARRAY_SIZE));
	fcost = malloc(sizeof(int)*(MAX_WPARRAY_SIZE));
	list = malloc(sizeof(char)*(MAX_WPARRAY_SIZE));
	parent = malloc(sizeof(int)*(MAX_WPARRAY_SIZE));
