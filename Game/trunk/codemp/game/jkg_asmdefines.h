...
// End of data defines
	...
	#define __JKG_StartHook( a )		__asm lea eax, [__hookstart] \
								__asm jmp __hookend \
								__asm __hookstart:
	#define __JKG_EndHook( a )		__asm __hookend:
...
// End of data defines
	...
	#define __JKG_StartHook( a ) __asm__("lea eax, [__hookstart" #a "]\n"); \
								__asm__("jmp __hookend" #a "\n"); \
                                __asm__("__hookstart" #a ":\n");

	#define __JKG_EndHook( a )  __asm__("__hookend" #a ":\n");
#endif
