...
//
// UQ1: Quick and dirty port of main() above... This may need to be threaded??? I don't know...
//
extern "C"
{
	#include "../cgame/cg_local.h"

	void	gameswf_processor(char *filename)
	{
		assert(tu_types_validate());
		...
		*/
		...
		infiles.push_back(filename); // UQ1: FIXME - Add this file to the list...
		s_append = true; // UQ1: Write cache file...
